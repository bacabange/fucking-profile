...
export type IPostFieldsFragment = {
  __typename?: "Post";
  title?: string | null | undefined;
  slug?: string | null | undefined;
  url?: string | null | undefined;
...
export type IGetAuthorListQueryVariables = Exact<{
  ...
  skip?: InputMaybe<Scalars["Int"]>;
  order?: InputMaybe<
    Array<InputMaybe<IAuthorOrder>> | InputMaybe<IAuthorOrder>
  >;
}>;
...
export function getSdk(
  ...
  return {
    ...
    getPostList(
      variables?: IGetPostListQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<IGetPostListQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<IGetPostListQuery>(GetPostListDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getPostList"
    ...
    getPost(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<IGetPostQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<IGetPostQuery>(GetPostDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getPost"
    ...
    getPostListByCategory(
      variables: IGetPostListByCategoryQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<IGetPostListByCategoryQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<IGetPostListByCategoryQuery>(
            GetPostListByCategoryDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "getPostListByCategory"
    ...
    getCategory(
      variables: IGetCategoryQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<IGetCategoryQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<IGetCategoryQuery>(GetCategoryDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getCategory"

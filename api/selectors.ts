...
export const selectAuthor = nonEmpty<PartialAuthor, Author>(partialAuthor => ({
...
type PartialCategory = PartialEntityWithId &
  Pick<ICategory, "title" | "slug" | "icon" | "color">;
...
type PartialPost = PartialEntityWithId &
  Pick<IPost, "slug" | "title" | "summary" | "date" | "url" | "body"> & {
